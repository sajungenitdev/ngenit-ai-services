...
import { createOutcome } from "@/services/outcomeApi";
import { OutcomeData } from "@/types/admin/outcome";

const defaultOutcomeData: OutcomeData = {
    icon: "⏱️",
    title: "",
    description: "",
    stat: "",
...
export default function CreateOutcomePage() {
    const router = useRouter();
    const [saving, setSaving] = useState(false);
    const [error, setError] = useState("");
    const [saveStatus, setSaveStatus] = useState<"idle" | "saving" | "saved" | "error">("idle");
    const [formData, setFormData] = useState<OutcomeData>(defaultOutcomeData);
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            {/* Form */}
            <form id="outcome-form" onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-grey-100 p-6">
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="⏱️"
                        />
                        <p className="text-xs text-grey-400 mt-1">Use an emoji as the icon</p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Automate repetitive document processing, data entry and reporting tasks."
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-3 rounded-lg border border-grey-200 focus:border-blue outline-none transition-all"
                            placeholder="Up to 70%"
                            required
                        />
                        <p className="text-xs text-grey-400 mt-1">The measurable outcome or result</p>
                    </div>
