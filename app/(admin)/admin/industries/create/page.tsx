...
export default function CreateIndustryPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // API Call
            const result = await createIndustry(filteredData);
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h2 className="text-2xl font-bold text-navy font-plus-jakarta">
                        Create Industry Solution
                    </h2>
                    <p className="text-grey-400 text-sm">
                        Add a new industry solution to your website
                    </p>
                </div>
                        ...
                        <div className="border-b border-grey-100 pb-6">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-grey-400 mt-1">
                                    URL-friendly name (auto-generated from industry name)
                                </p>
                            </div>
