...
export default function TermsConditionsAdminPage() {
    ...
    const [policy, setPolicy] = useState<TermsConditions>({
    ...
    const [versions, setVersions] = useState<TermsConditions[]>([]);
    ...
    const fetchPolicy = async () => {
        try {
            setLoading(true);
            const data = await apiFetch("/terms-conditions");
    ...
    const fetchVersions = async () => {
        try {
            const data = await apiFetch("/terms-conditions/versions");
            if (data.success) {
    ...
    const handlePublish = async () => {
        ...
        setPublishing(true);
        try {
            const data = await apiFetch(`/terms-conditions/${policy._id}/publish`, {
                method: "PATCH",
            });
    ...
    const handleArchive = async () => {
        ...
        setArchiving(true);
        try {
            const data = await apiFetch(`/terms-conditions/${policy._id}/archive`, {
                method: "PATCH",
            });
    ...
    const handleDelete = async () => {
        ...
        try {
            const data = await apiFetch(`/terms-conditions/${policy._id}`, {
                method: "DELETE",
            });
    ...
    const loadVersion = async (version: number) => {
        try {
            const data = await apiFetch(`/terms-conditions/version/${version}`);
            if (data.success) {
                setPolicy(data.data);
                setUnsavedChanges(false);
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-2xl w-full max-w-md p-6">
                        <div className="text-center">
                            ...
                            <p className="text-gray-500 text-sm mb-6">
                                This will make the terms & conditions publicly visible on your website.
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-2xl w-full max-w-md p-6">
                        <div className="text-center">
                            ...
                            <p className="text-gray-500 text-sm mb-6">
                                Are you sure you want to delete this terms & conditions? This action
                                cannot be undone.
                            </p>
                            <div className="flex gap-3">
                                <button
