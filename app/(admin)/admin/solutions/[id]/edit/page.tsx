...
import { getSolutionById, updateSolution } from "@/services/solutionApi";
    ...
    useEffect(() => {
        const fetchSolution = async () => {
            try {
                ...
                setError("Failed to load solution data. Please try again.");
            } finally {
                setLoading(false);
            }
        };
        ...
        return (
            <div className="flex items-center justify-center h-64">
                <div className="text-center">
                    ...
                    <p className="text-grey-400 mt-4">Loading solution...</p>
                </div>
            </div>
        );
    }
