                ...
                <section className="relative bg-navy pt-40 pb-20 overflow-hidden">
                    ...
                    <div className="container max-w-[1200px] mx-auto px-6 md:px-8 relative z-10">
                        ...
                        <div className="animate-pulse">
                            ...
                            <div className="h-6 w-1/2 bg-white/10 rounded-lg mb-3"></div>
                ...
                <section className="py-12 md:py-16 bg-white">
                    <div className="container max-w-[800px] mx-auto px-6 md:px-8">
                        <div className="animate-pulse space-y-6">
                            <div className="h-64 bg-grey-100 rounded-xl"></div>
                            <div className="h-8 w-3/4 bg-grey-100 rounded-lg"></div>
                            <div className="h-4 w-full bg-grey-100 rounded-lg"></div>
                            <div className="h-4 w-full bg-grey-100 rounded-lg"></div>
                            <div className="h-4 w-2/3 bg-grey-100 rounded-lg"></div>
                            <div className="h-8 w-1/2 bg-grey-100 rounded-lg"></div>
                            <div className="h-4 w-full bg-grey-100 rounded-lg"></div>
                            <div className="h-4 w-full bg-grey-100 rounded-lg"></div>
                            <div className="h-4 w-3/4 bg-grey-100 rounded-lg"></div>
                        </div>
                    </div>
                </section>
            </div>
            ...
            <section className="py-12 md:py-16 bg-white">
                <div className="container max-w-[800px] mx-auto px-6 md:px-8">
                    ...
                    <div className="mb-8 p-6 bg-off-white rounded-xl border-l-4 border-cyan">
                        <p className="text-[1.05rem] text-grey-700 leading-relaxed italic">
                            {insight.excerpt}
                        </p>
                    </div>
