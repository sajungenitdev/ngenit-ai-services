        ...
        <section className="py-24 md:py-32 bg-off-white" id="industries" ref={sectionRef}>
            <div className="container max-w-[1200px] mx-auto px-6 md:px-8">
                ...
                <div className="text-center mt-8">
                    <Link
                        href="/industries"
                        className="inline-flex border border-1 border-gray-400 items-center gap-2 px-7 py-3.5 rounded-[8px] font-semibold text-[0.95rem]  transition-all duration-200 whitespace-nowrap bg-transparent text-navy  hover:bg-off-white hover:border-navy"
                    >
                        View All Industries →
                    </Link>
                </div>
